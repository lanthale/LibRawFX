...
public class decode {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(2, C_POINTER).withName("branch"),
        C_INT.withName("leaf"),
    ...
    static final VarHandle leaf$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("leaf"));
