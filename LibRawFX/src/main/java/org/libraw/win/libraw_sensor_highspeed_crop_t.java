...
public class libraw_sensor_highspeed_crop_t {
    ...
    public static short cleft$get(MemorySegment seg) {
        return (short)constants$32.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short cleft$get(MemorySegment seg, long index) {
        return (short)constants$32.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short ctop$get(MemorySegment seg) {
        return (short)constants$33.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short ctop$get(MemorySegment seg, long index) {
        return (short)constants$33.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short cwidth$get(MemorySegment seg) {
        return (short)constants$33.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short cwidth$get(MemorySegment seg, long index) {
        return (short)constants$33.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short cheight$get(MemorySegment seg) {
        return (short)constants$33.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short cheight$get(MemorySegment seg, long index) {
        return (short)constants$33.const$2.get(seg.asSlice(index*sizeof()));
    }
