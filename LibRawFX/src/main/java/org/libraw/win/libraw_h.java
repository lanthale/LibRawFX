...
public final class libraw_h  {
    ...
    public static class libraw_colordata_t {
        ...
        public static MemorySegment linear_max$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(147500, 16));
        }
        ...
        public static MemorySegment white$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(147524, 128));
        }
        public static MemorySegment cam_mul$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(147652, 16));
        }
        public static MemorySegment pre_mul$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(147668, 16));
        }
        public static MemorySegment cmatrix$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(147684, 48));
        }
        public static MemorySegment ccm$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(147732, 48));
        }
        public static MemorySegment rgb_cam$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(147780, 48));
        }
        public static MemorySegment cam_xyz$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(147828, 48));
        }
        public static MemorySegment phase_one_data$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(147876, 36));
        }
        ...
        public static MemorySegment model2$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(147920, 64));
        }
        public static MemorySegment UniqueCameraModel$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(147984, 64));
        }
        public static MemorySegment LocalizedCameraModel$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(148048, 64));
        }
        public static MemorySegment ImageUniqueID$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(148112, 64));
        }
        public static MemorySegment RawDataUniqueID$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(148176, 17));
        }
        public static MemorySegment OriginalRawFileName$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(148193, 64));
        }
        ...
        public static MemorySegment black_stat$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(148276, 32));
        }
        public static MemorySegment dng_color$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(148308, 336));
        }
        public static MemorySegment dng_levels$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(148644, 32920));
        }
        public static MemorySegment WB_Coeffs$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(181564, 4096));
        }
        public static MemorySegment WBCT_Coeffs$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(185660, 1280));
        }
        ...
        public static MemorySegment P1_color$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(186944, 72));
        }
    ...
    public static class libraw_rawdata_t {
        ...
        public static MemorySegment color$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(704, 187024));
        }
        public static long sizeof() { return $LAYOUT().byteSize(); }
        public static  MemorySegment allocate() { return MemorySegment.allocateNative($LAYOUT()); }
        public static  MemorySegment allocate(NativeScope scope) { return scope.allocate($LAYOUT()); }
    ...
    public static class libraw_data_t {
        ...
        public static MemorySegment color$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(5384, 187024));
        }
        public static MemorySegment other$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(192408, 800));
        }
        public static MemorySegment thumbnail$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(193208, 24));
        }
        public static MemorySegment rawdata$slice(MemorySegment seg) {
            return RuntimeHelper.nonCloseableNonTransferableSegment(seg.asSlice(193232, 187728));
        }
    ...
    public static  MethodHandle libraw_open_wfile$MH() {
        return RuntimeHelper.requireNonNull(libraw_h_constants_3.libraw_open_wfile$MH(),"unresolved symbol: libraw_open_wfile");
    }
    public static int libraw_open_wfile ( Addressable x0,  Addressable x1) {
        var mh$ = RuntimeHelper.requireNonNull(libraw_h_constants_3.libraw_open_wfile$MH(), "unresolved symbol: libraw_open_wfile");
        try {
            return (int)mh$.invokeExact(x0.address(), x1.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static  MethodHandle libraw_open_wfile_ex$MH() {
        return RuntimeHelper.requireNonNull(libraw_h_constants_3.libraw_open_wfile_ex$MH(),"unresolved symbol: libraw_open_wfile_ex");
    }
    public static int libraw_open_wfile_ex ( Addressable x0,  Addressable x1,  long max_buff_sz) {
        var mh$ = RuntimeHelper.requireNonNull(libraw_h_constants_3.libraw_open_wfile_ex$MH(), "unresolved symbol: libraw_open_wfile_ex");
        try {
            return (int)mh$.invokeExact(x0.address(), x1.address(), max_buff_sz);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
