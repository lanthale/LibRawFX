...
public class libraw_h  {
    ...
    public static int libraw_open_file_ex ( Addressable x0,  Addressable x1,  long max_buff_sz) {
        ...
        try {
            return (int)mh$.invokeExact(x0, x1, max_buff_sz);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    public static MethodHandle libraw_open_wfile$MH() {
        return RuntimeHelper.requireNonNull(constants$3.libraw_open_wfile$MH,"libraw_open_wfile");
    }
    public static int libraw_open_wfile ( Addressable x0,  Addressable x1) {
        var mh$ = RuntimeHelper.requireNonNull(constants$3.libraw_open_wfile$MH, "libraw_open_wfile");
        try {
            return (int)mh$.invokeExact(x0, x1);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static MethodHandle libraw_open_wfile_ex$MH() {
        return RuntimeHelper.requireNonNull(constants$3.libraw_open_wfile_ex$MH,"libraw_open_wfile_ex");
    }
    public static int libraw_open_wfile_ex ( Addressable x0,  Addressable x1,  long max_buff_sz) {
        var mh$ = RuntimeHelper.requireNonNull(constants$3.libraw_open_wfile_ex$MH, "libraw_open_wfile_ex");
        try {
            return (int)mh$.invokeExact(x0, x1, max_buff_sz);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static MethodHandle libraw_unpack$MH() {
        return RuntimeHelper.requireNonNull(constants$4.libraw_unpack$MH,"libraw_unpack");
    }
    public static int libraw_unpack ( Addressable x0) {
        var mh$ = RuntimeHelper.requireNonNull(constants$4.libraw_unpack$MH, "libraw_unpack");
        try {
    ...
    public static MethodHandle libraw_unpack_thumb$MH() {
        return RuntimeHelper.requireNonNull(constants$4.libraw_unpack_thumb$MH,"libraw_unpack_thumb");
    }
    public static int libraw_unpack_thumb ( Addressable x0) {
        var mh$ = RuntimeHelper.requireNonNull(constants$4.libraw_unpack_thumb$MH, "libraw_unpack_thumb");
        try {
            return (int)mh$.invokeExact(x0);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static MethodHandle libraw_raw2image$MH() {
        return RuntimeHelper.requireNonNull(constants$5.libraw_raw2image$MH,"libraw_raw2image");
    }
    public static int libraw_raw2image ( Addressable x0) {
        var mh$ = RuntimeHelper.requireNonNull(constants$5.libraw_raw2image$MH, "libraw_raw2image");
        try {
            return (int)mh$.invokeExact(x0);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static MethodHandle libraw_free_image$MH() {
        return RuntimeHelper.requireNonNull(constants$5.libraw_free_image$MH,"libraw_free_image");
    }
    public static void libraw_free_image ( Addressable x0) {
        var mh$ = RuntimeHelper.requireNonNull(constants$5.libraw_free_image$MH, "libraw_free_image");
        try {
            mh$.invokeExact(x0);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static void libraw_set_memerror_handler ( Addressable x0,  Addressable cb,  Addressable datap) {
        var mh$ = RuntimeHelper.requireNonNull(constants$6.libraw_set_memerror_handler$MH, "libraw_set_memerror_handler");
        try {
    ...
    public static void libraw_set_exifparser_handler ( Addressable x0,  Addressable cb,  Addressable datap) {
        var mh$ = RuntimeHelper.requireNonNull(constants$6.libraw_set_exifparser_handler$MH, "libraw_set_exifparser_handler");
        try {
            mh$.invokeExact(x0, cb, datap);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static MethodHandle libraw_COLOR$MH() {
        return RuntimeHelper.requireNonNull(constants$7.libraw_COLOR$MH,"libraw_COLOR");
    }
    public static int libraw_COLOR ( Addressable x0,  int row,  int col) {
        var mh$ = RuntimeHelper.requireNonNull(constants$7.libraw_COLOR$MH, "libraw_COLOR");
        try {
    ...
    public static MethodHandle libraw_capabilities$MH() {
        return RuntimeHelper.requireNonNull(constants$7.libraw_capabilities$MH,"libraw_capabilities");
    }
    public static int libraw_capabilities (Object... x0) {
        var mh$ = RuntimeHelper.requireNonNull(constants$7.libraw_capabilities$MH, "libraw_capabilities");
        try {
            return (int)mh$.invokeExact(x0);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static MethodHandle libraw_dcraw_make_mem_image$MH() {
        return RuntimeHelper.requireNonNull(constants$8.libraw_dcraw_make_mem_image$MH,"libraw_dcraw_make_mem_image");
    }
    public static MemoryAddress libraw_dcraw_make_mem_image ( Addressable lr,  Addressable errc) {
        var mh$ = RuntimeHelper.requireNonNull(constants$8.libraw_dcraw_make_mem_image$MH, "libraw_dcraw_make_mem_image");
        try {
    ...
    public static MethodHandle libraw_dcraw_make_mem_thumb$MH() {
        return RuntimeHelper.requireNonNull(constants$8.libraw_dcraw_make_mem_thumb$MH,"libraw_dcraw_make_mem_thumb");
    }
    public static MemoryAddress libraw_dcraw_make_mem_thumb ( Addressable lr,  Addressable errc) {
        var mh$ = RuntimeHelper.requireNonNull(constants$8.libraw_dcraw_make_mem_thumb$MH, "libraw_dcraw_make_mem_thumb");
        try {
            return (jdk.incubator.foreign.MemoryAddress)mh$.invokeExact(lr, errc);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static MethodHandle libraw_set_output_bps$MH() {
        return RuntimeHelper.requireNonNull(constants$9.libraw_set_output_bps$MH,"libraw_set_output_bps");
    }
    public static void libraw_set_output_bps ( Addressable lr,  int value) {
        var mh$ = RuntimeHelper.requireNonNull(constants$9.libraw_set_output_bps$MH, "libraw_set_output_bps");
        try {
            mh$.invokeExact(lr, value);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static MethodHandle libraw_get_raw_height$MH() {
        return RuntimeHelper.requireNonNull(constants$10.libraw_get_raw_height$MH,"libraw_get_raw_height");
    }
    public static int libraw_get_raw_height ( Addressable lr) {
        var mh$ = RuntimeHelper.requireNonNull(constants$10.libraw_get_raw_height$MH, "libraw_get_raw_height");
        try {
            return (int)mh$.invokeExact(lr);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static MethodHandle libraw_get_rgb_cam$MH() {
        return RuntimeHelper.requireNonNull(constants$11.libraw_get_rgb_cam$MH,"libraw_get_rgb_cam");
    }
    public static float libraw_get_rgb_cam ( Addressable lr,  int index1,  int index2) {
        var mh$ = RuntimeHelper.requireNonNull(constants$11.libraw_get_rgb_cam$MH, "libraw_get_rgb_cam");
        try {
    ...
    public static int LIBRAW_USE_STREAMS_DATASTREAM_MAXSIZE() {
        return (int)262144000L;
    }
    ...
    public static MemorySegment LIBRAW_VERSION_STR() {
        return constants$12.LIBRAW_VERSION_STR$SEGMENT;
    }
