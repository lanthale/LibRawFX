...
public class libraw_nikon_makernotes_t {
    ...
    static final VarHandle AFPoint$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("AFPoint"));
    ...
    static final VarHandle AFPointsInFocus$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("AFPointsInFocus"));
    ...
    static final VarHandle ContrastDetectAF$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("ContrastDetectAF"));
    ...
    static final VarHandle AFAreaMode$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("AFAreaMode"));
    ...
    static final VarHandle PhaseDetectAF$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("PhaseDetectAF"));
    ...
    static final VarHandle PrimaryAFPoint$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("PrimaryAFPoint"));
    ...
    static final VarHandle AFAreaXPposition$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("AFAreaXPposition"));
    ...
    static final VarHandle AFAreaYPosition$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("AFAreaYPosition"));
    ...
    static final VarHandle AFAreaWidth$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("AFAreaWidth"));
    ...
    static final VarHandle AFAreaHeight$VH = $struct$LAYOUT.varHandle(short.class, MemoryLayout.PathElement.groupElement("AFAreaHeight"));
    ...
    static final VarHandle ContrastDetectAFInFocus$VH = $struct$LAYOUT.varHandle(byte.class, MemoryLayout.PathElement.groupElement("ContrastDetectAFInFocus"));
