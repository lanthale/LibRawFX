...
public class libraw_afinfo_item_t {
    ...
    public static MemoryAddress AFInfoData$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)libraw_afinfo_item_t.AFInfoData$VH.get(seg);
    }
    ...
    public static MemoryAddress AFInfoData$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)libraw_afinfo_item_t.AFInfoData$VH.get(seg.asSlice(index*sizeof()));
    }
