...
public class libraw_fuji_info_t {
    ...
    static final VarHandle FrameRate$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("FrameRate"));
    ...
    static final VarHandle FrameWidth$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("FrameWidth"));
    ...
    static final VarHandle FrameHeight$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("FrameHeight"));
