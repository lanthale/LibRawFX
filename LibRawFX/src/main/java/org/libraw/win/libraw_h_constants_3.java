...
class libraw_h_constants_3 extends libraw_h_constants_2 {
    ...
    static final FunctionDescriptor libraw_open_wfile$FUNC_ = FunctionDescriptor.of(C_INT,
        C_POINTER,
        C_POINTER
    );
    static final jdk.incubator.foreign.FunctionDescriptor libraw_open_wfile$FUNC() { return libraw_open_wfile$FUNC_; }

    static final MethodHandle libraw_open_wfile$MH_ = RuntimeHelper.downcallHandle(
        LIBRARIES, "libraw_open_wfile",
        "(Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;)I",
        libraw_open_wfile$FUNC_, false
    );
    static final java.lang.invoke.MethodHandle libraw_open_wfile$MH() { return libraw_open_wfile$MH_; }

    static final FunctionDescriptor libraw_open_wfile_ex$FUNC_ = FunctionDescriptor.of(C_INT,
        C_POINTER,
        C_POINTER,
        C_LONG_LONG
    );
    static final jdk.incubator.foreign.FunctionDescriptor libraw_open_wfile_ex$FUNC() { return libraw_open_wfile_ex$FUNC_; }

    static final MethodHandle libraw_open_wfile_ex$MH_ = RuntimeHelper.downcallHandle(
        LIBRARIES, "libraw_open_wfile_ex",
        "(Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;J)I",
        libraw_open_wfile_ex$FUNC_, false
    );
    static final java.lang.invoke.MethodHandle libraw_open_wfile_ex$MH() { return libraw_open_wfile_ex$MH_; }
    ...
    static final int LIBRAW_USE_STREAMS_DATASTREAM_MAXSIZE() { return (int)262144000L; }
    ...
    static final int LIBRAW_MAX_ALLOC_MB_DEFAULT() { return (int)2048L; }

    static final int LIBRAW_MAX_THUMBNAIL_MB() { return (int)512L; }
